...
export default function QRScanner(): React.JSX.Element {
  ...
  const { addScannedAddress } = useWallet();
  ...
  const handleBarCodeScanned = ({ type, data }: any) => {
    ...
    // Parse using the integrated SMS branch parser
    ...
    // Deep route to the transaction page pre-filled
    router.replace({
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.overlay}>
        ...
        <View style={styles.centerCrop}>
          ...
          <Text style={styles.cropText}>Align QR/UPI code inside frame</Text>
        </View>
      </View>
    </SafeAreaView>
  );
