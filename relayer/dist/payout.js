...
exports.meshtToInr = meshtToInr;
exports.triggerInrPayout = triggerInrPayout;
/**
...
async function triggerInrPayout(toUpiId, amountInr, txHash, merchantName = "Merchant") {
    ...
    try {
        ...
        const { decentro_txn_id, api_status, transaction_status, bank_reference_number, message, response_key, data } = response.data;
